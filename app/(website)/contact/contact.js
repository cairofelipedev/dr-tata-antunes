  ...
  return (
    <Container>
      ...
      <div className="text-center">
        <p className="text-lg">
          Estamos aqui para ajudar. Preencha o formulário ou envie
          e-mail ou ligue para o telefone.
        </p>
      </div>
        ...
        <div>
          <form onSubmit={handleSubmit(onSubmit)} className="my-10">
            ...
            <div className="mb-5">
              ...
              <input
                ...
                {...register("email", {
                  required: "Digite seu endereço de email",
                  pattern: {
                    value: /^\S+@\S+$/i,
          ...
          {isSubmitSuccessful && isSuccess && (
            <div className="mt-3 text-center text-sm text-green-500">
              {message || "Sua mensagem enviada com sucesso"}
            </div>
          )}
          {isSubmitSuccessful && !isSuccess && (
